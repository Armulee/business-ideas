...
export default function NotificationSheet() {
    ...
    const notifications = useMemo(() => data?.activities ?? [], [data])
    ...
    const markAsRead = useCallback(async () => {
        ...
        mutate(
            {
                hasSeenWelcome,
                activities: notifications.map((n) => ({ ...n, isRead: true })),
            },
            false
        )
    }, [notifications, session, mutate, hasSeenWelcome])
    ...
    return (
        <>
            ...
            <WelcomeDialog hasSeenWelcome={hasSeenWelcome} />
        </>
    )
}
