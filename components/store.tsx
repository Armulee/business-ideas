export const categories = [
    ...
    { id: 6, name: "Aerospace & Defense" },
    { id: 7, name: "Construction" },
    { id: 8, name: "Consumer Goods" },
    { id: 9, name: "Chemical & Pharmaceutical" },
    { id: 10, name: "Energy & Utilities" },
    { id: 11, name: "Food & Beverage" },
    { id: 12, name: "Retail & E-commerce" },
    { id: 13, name: "Transportation & Logistics" },
    { id: 14, name: "Hospitality & Tourism" },
    { id: 15, name: "Healthcare & Biotechnology" },
    { id: 16, name: "Education & Training" },
    { id: 17, name: "Financial Services" },
    { id: 18, name: "Real Estate" },
    { id: 19, name: "Professional Services" },
    { id: 20, name: "Marketing & Advertising" },
    { id: 21, name: "Technology & IT" },
    { id: 22, name: "Media & Entertainment" },
    { id: 23, name: "Telecommunications" },
    { id: 24, name: "Research & Development (R&D)" },
    { id: 25, name: "Government & Public Services" },
    { id: 26, name: "Nonprofits & NGOs" },
]
