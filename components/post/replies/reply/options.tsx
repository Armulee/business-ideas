...
const ReplyOptions = ({ reply, setIsEditing }: ReplyOptionsProps) => {
    const { data: session } = useSession()
    const permission = reply.author._id.toString() === session?.user.id
    ...
    return (
        <Popover>
            ...
            <PopoverContent className='w-52 glasmmorphism bg-black/10 p-2 border-0'>
